...
Future<Map<String, dynamic>> sourceforgeUpdate() async {
  const url = 'https://sourceforge.net/projects/maylo/files/json';

  final headers = {
    'User-Agent':
        'Mozilla/5.0 (Linux; Android 13; MayloApp) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Mobile Safari/537.36',
    'Accept': 'application/json',
    'Referer': 'https://sourceforge.net/projects/maylo/',
  };
...
Future<Map<String, dynamic>> githubUpdate() async {
  ...
  try {
    final response = await get(
      Uri.parse(
        'https://api.github.com/repos/Harish-Srinivas-07/maylo/releases/latest',
      ),
    );
    ...
    if (response.statusCode == 200) {
      ...
      return {
        ...
        'newVer': version,
        'download_url':
            "https://sourceforge.net/projects/maylo/files/latest/download",
      };
    } else {
